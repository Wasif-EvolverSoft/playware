...
var uploadProductForm = document.querySelector('form[action="{{ route('
    auth.uploadProduct ') }}"]');
...
$(document).ready(function() {
    if ({
            {
                old('ProductType') == '1' || old('ProductType') == '5' ? 'true' : 'false'
            }
        }) {
        $('#repairedProductDiv').removeClass('d-none');
        $('#repairedProductDiv').empty();
    ...
    if ({
            {
                old('productCategory') == '11' ? 'true' : 'false'
            }
        }) {
        $('#additionalRequirements').removeClass('d-none');
        $('#additionalRequirements').html(`<h2>Additional Requirements:</h2>
            ...
            {
                old('productCategory') == '5' ? 'true' : 'false'
            }
        }) {
        $('#additionalRequirements').removeClass('d-none');
        $('#additionalRequirements').html(`<h2>Additional Requirements:</h2>
            ...
            {
                old('productCategory') == '6' ? 'true' : 'false'
            }
        }) {
        $('#additionalRequirements').removeClass('d-none');
        $('#additionalRequirements').html(`<h2>Additional Requirements:</h2>
